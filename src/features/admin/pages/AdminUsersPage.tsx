...
// Admin panel — barcha foydalanuvchilar ro'yxati: a'zolar soni, tarif,
// qo'shimcha slot (har birligi 100 a'zo) va daraxtni to'liq ko'rish.
...
import { adminApi, type AdminUserSummary } from '@/features/admin/api/admin.api';

...
describe('RegisterPage (ikki bosqichli: forma -> kod)', () => {
  ...
  it("to'g'ri kod kiritilgach sessiya ochiladi va bosh sahifaga o'tadi", async () => {
    ...
    mockApi.confirmRegister.mockResolvedValue({
      user: { id: 'u1', fullName: 'Test Foydalanuvchi', phone: '+998901234567', email: 'test@example.com', profileVisibility: 'PUBLIC', searchVisibility: 'PUBLIC', dataVisibility: 'PUBLIC', messageVisibility: 'PUBLIC', telegramLinked: false, telegramId: null, hasPassword: true, isAdmin: false },
      accessToken: 'at-123',
    });
    render(
      <MemoryRouter>

...
describe('useSessionLiveness', () => {
  ...
  it('har 20 soniyada /auth/me chaqirib sessiya faolligini tekshiradi', async () => {
    mockApi.me.mockResolvedValue({ id: 'u1', fullName: 'Test', phone: null, email: 't@t.uz', profileVisibility: 'PUBLIC' as const, searchVisibility: 'PUBLIC' as const, dataVisibility: 'PUBLIC' as const, messageVisibility: 'PUBLIC' as const, telegramLinked: false, telegramId: null, hasPassword: true });
